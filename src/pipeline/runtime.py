"""Runtime data assembly helpers for pipeline stages."""
...
def load_base_dataset(paths: PipelinePaths) -> Dataset:
    """Load source dataset from raw data directory."""
    return Dataset.load(paths.data_dir)


def load_runtime_dataset(paths: PipelinePaths) -> Dataset:
    """Load runtime dataset with interactions restored from cached artifact."""
