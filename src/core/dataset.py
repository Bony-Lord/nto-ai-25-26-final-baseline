"""Dataset container and loader for baseline pipeline."""
...
from src.io.loaders import read_csv
from src.utils.schema import ensure_columns


@dataclass(frozen=True)
class Dataset:
    """Loaded dataset with normalized frames."""
    ...
    def load(data_dir: Path) -> "Dataset":
        """Read source CSV files and normalize schema."""
        required_files = {
